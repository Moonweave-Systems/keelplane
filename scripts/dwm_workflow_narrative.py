...
def make_narrative(
    ...
    *,
    ...
    if roadmap_latest != "V98":
        add_blocker(blockers, "ERR_WORKFLOW_NARRATIVE_ROADMAP_STALE", "roadmap latest version is stale", surface="roadmap", actual=roadmap_latest, expected="V98")
    ...
    if activation_inputs.get("roadmap_latest_version") != "V98":
        add_blocker(blockers, "ERR_WORKFLOW_NARRATIVE_ACTIVATION_ROADMAP_STALE", "activation consumed a stale roadmap version", surface="activation", actual=activation_inputs.get("roadmap_latest_version"), expected="V98")
    ...
    stages = [
        stage(
            "chart",
            "Chart",
            "clear" if roadmap.get("decision") == "roadmap_reconciled" and roadmap_latest == "V98" and not roadmap.get("blocked_by") else "blocked",
