...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder, V97 benchmark readiness, V98 wave operator, V99 wave receipt, V100 promotion evidence, V101 promotion route, V102 deterministic live-proof recorder, V103 live-proof comparison schema, V104 product direction, V105 verify wedge, V106 multi-wave validation, V107 Agent Fabric compiler, V108 reference adapter fixture, V109 capture bridge, V110 report assurance, V111 operator view, V112 lifecycle smoke, V116 Agent Fabric smoke CLI, V117 Agent Fabric harness snapshot, V118 Agent Fabric adapter smoke, V119 Agent Fabric claim gate, V120 paired evidence gate")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V120: Product Evidence, Control Deck, And Agent Fabric Guardrails")
