...
V104 product direction, V105 verify wedge, V106 multi-wave validation, and V107-V120 Agent Fabric guardrails.
...
- `docs/automation-roadmap.md` still says V12-V20 are planned but not
  implemented.
- `docs/automation-roadmap.md` lacks the V52-V120 continuation summary.
