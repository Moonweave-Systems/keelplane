...
### V107-V121: Agent Fabric Compiler, Capture, Report, Operator View, Lifecycle Smoke, Smoke CLI, Harness Snapshot, Adapter Smoke, Claim Gate, Paired Evidence, And Paired Evidence CLI

V107-V121 add the first implemented Agent Fabric control-plane layer without
...
Agent Fabric product step should focus on replacing source-only dogfood
evidence stubs with controlled-run evidence before any public benefit, live
adapter, or superiority claim.
