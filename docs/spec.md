...
### V107-V120: Agent Fabric Compiler, Capture, Report, Operator View, Lifecycle Smoke, Smoke CLI, Harness Snapshot, Adapter Smoke, Claim Gate, And Paired Evidence

V107-V120 add the first implemented Agent Fabric control-plane layer without
...
Agent Fabric product step should focus on producing real paired dogfood
evidence from controlled runs before any public benefit, live adapter, or
superiority claim.
